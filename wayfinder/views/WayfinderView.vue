          ...
          <div class="card-content">
            ...
            <div class="balance-details">
              <div class="detail-item">
                <span class="detail-label">Rotas:</span>
...
export default {
  ...
  data() {
    return {
      config: getServiceConfig('wayfinder')
    }
  },
  methods: {
    refreshData() {
      console.log('Atualizando dados do Wayfinder...')
      // Aqui você faria a chamada para a API do Wayfinder
      // e atualizaria os dados em tempo real
    },
    openModule() {
      window.open('http://localhost:3711/', '_blank')
    }
  }
}
</script>
