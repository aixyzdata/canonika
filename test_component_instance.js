...
async function testComponentInstance() {
  console.log('🔍 Testando instância do componente...');
  ...
  try {
    ...
    if (loginForm) {
      ...
      // Tentar acessar a instância do componente através do elemento DOM
      console.log('🔍 Tentando acessar a instância do componente...');
      const componentResult = await page.evaluate(() => {
        if (window.app && window.app.__vue_app__) {
          ...
          // Tentar acessar o componente através do _instance
          if (vueApp._instance) {
            console.log('_instance encontrado:', vueApp._instance);
            return { success: true, hasInstance: true };
          } else {
            console.log('_instance não encontrado');
            
            // Tentar acessar através do _vnode
            if (vueApp._vnode) {
              console.log('_vnode encontrado:', vueApp._vnode);
              return { success: true, hasVnode: true };
            } else {
              console.log('_vnode não encontrado');
              return { success: false, error: 'Nenhuma instância encontrada' };
            }
          }
        } else {
      ...
      console.log('🔍 Resultado do componente:', componentResult);
