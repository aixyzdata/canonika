        ...
        <div class="logo-section">
          ...
          <div class="logo-text-container">
            ...
            <div class="module-title-with-icon">
              <div class="module-icon icon-quarter"></div>
    ...
    <div class="canonika-layout" :class="{ 'sidebar-collapsed': sidebarCollapsed }">
      ...
      <nav class="canonika-sidebar" v-if="user" :class="{ 'sidebar-collapsed': sidebarCollapsed }">
        ...
        <ul class="nav-menu">
          ...
          <li class="nav-item" :class="{ active: currentView === 'trimestres' }">
            <div class="nav-link" @click="setView('trimestres')">
              <div class="nav-icon">
                <i class="fas fa-calendar-alt"></i>
              </div>
              <div v-if="!sidebarCollapsed" class="nav-text">
                <span class="nav-title">Trimestres</span>
                <span class="service-subtitle">Períodos</span>
              </div>
            </div>
          </li>
          <li class="nav-item" :class="{ active: currentView === 'analises' }">
            <div class="nav-link" @click="setView('analises')">
              <div class="nav-icon">
                <i class="fas fa-chart-line"></i>
              </div>
              <div v-if="!sidebarCollapsed" class="nav-text">
                <span class="nav-title">Análises</span>
                <span class="service-subtitle">Insights</span>
              </div>
            </div>
          </li>
          <li class="nav-item" :class="{ active: currentView === 'metricas' }">
            <div class="nav-link" @click="setView('metricas')">
              <div class="nav-icon">
                <i class="fas fa-chart-bar"></i>
              </div>
              <div v-if="!sidebarCollapsed" class="nav-text">
                <span class="nav-title">Métricas</span>
                <span class="service-subtitle">KPIs</span>
              </div>
            </div>
          </li>
          <li class="nav-item" :class="{ active: currentView === 'relatorios' }">
            <div class="nav-link" @click="setView('relatorios')">
              ...
              <div v-if="!sidebarCollapsed" class="nav-text">
                ...
                <span class="service-subtitle">Documentos</span>
              </div>
            </div>
          </li>
        </ul>
      ...
      <main class="canonika-main" :class="{ 'sidebar-collapsed': sidebarCollapsed }">
        ...
        <div v-else-if="currentView === 'dashboard'" class="dashboard-container">
          <div class="dashboard-header">
            <h1>Dashboard Quarter</h1>
            <p>Sistema de análise trimestral e métricas empresariais</p>
          </div>
              ...
              <div class="card-content">
                <div class="service-status-list">
                  <div class="service-status online">
                    ...
                    <span class="service-name">Análise Trimestral</span>
                    <span class="service-port">ATIVO</span>
                  </div>
                  <div class="service-status online">
                    <span class="status-dot"></span>
                    <span class="service-name">Coleta de Métricas</span>
                    <span class="service-port">ATIVO</span>
                  </div>
                  <div class="service-status online">
                    <span class="status-dot"></span>
                    <span class="service-name">Geração de Relatórios</span>
                    <span class="service-port">ATIVO</span>
                  </div>
                </div>
              </div>
              ...
              <div class="card-content">
                <div class="stats-grid">
                  <div class="stat-item">
                    ...
                    <div class="stat-label">Meta Alcançada</div>
                  </div>
                  <div class="stat-item">
                    <div class="stat-value">156</div>
                    <div class="stat-label">KPIs Monitorados</div>
                  </div>
                  <div class="stat-item">
            ...
            <div class="dashboard-card">
              ...
              <div class="card-content">
                <div class="quick-actions">
                  <button @click="setView('trimestres')" class="quick-action-btn">
                    <i class="fas fa-calendar-alt"></i>
                    Trimestres
                  </button>
                  <button @click="setView('analises')" class="quick-action-btn">
                    <i class="fas fa-chart-line"></i>
                    Análises
                  </button>
                  <button @click="setView('metricas')" class="quick-action-btn">
                    <i class="fas fa-chart-bar"></i>
                    Métricas
                  </button>
                ...
                <div class="activity-list">
                  <div class="activity-item">
                    ...
                    <div class="activity-content">
                      <div class="activity-title">Análise Q4 atualizada</div>
                  ...
                  <div class="activity-item">
                    ...
                    <div class="activity-content">
                      <div class="activity-title">Novas métricas coletadas</div>
...
export default {
  ...
  methods: {
    ...
    getServiceTitle() {
      ...
      return titles[this.currentView] || 'Quarter';
    },
    
    getServiceDescription() {
      const descriptions = {
        'trimestres': 'Gestão e análise de períodos trimestrais',
        'analises': 'Análises avançadas e insights de negócio',
        'metricas': 'Monitoramento de KPIs e indicadores',
        'relatorios': 'Geração e gestão de relatórios empresariais'
      };
      return descriptions[this.currentView] || 'Sistema de análise trimestral e métricas empresariais';
    },
