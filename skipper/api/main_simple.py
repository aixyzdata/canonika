...
app = FastAPI(
    title="Skipper API - Versão Simples",
    description="Orquestrador de navegação e extração de dados na web (versão simplificada)",
    version="1.0.0"
)
...
@app.get("/")
async def root():
    return {"message": "Skipper API - Versão Simples - Orquestrador de Navegação e Extração"}
...
if __name__ == "__main__":
    print("🚀 Iniciando Skipper API - Versão Simples...")
