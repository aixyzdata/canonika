...
export default {
  ...
  data() {
    return {
      config: getServiceConfig('dock')
    }
  },
  methods: {
    refreshData() {
      console.log('Atualizando dados do Dock...')
      // Aqui você faria a chamada para a API do Dock
      // e atualizaria os dados em tempo real
    },
    openModule() {
      window.open('http://localhost:3706/', '_blank')
    }
  }
}
</script>
