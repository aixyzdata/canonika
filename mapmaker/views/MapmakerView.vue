...
export default {
  ...
  data() {
    return {
      config: getServiceConfig('mapmaker')
    }
  },
  methods: {
    refreshData() {
      console.log('Atualizando dados do Mapmaker...')
      // Aqui você faria a chamada para a API do Mapmaker
      // e atualizaria os dados em tempo real
    },
    openModule() {
      window.open('http://localhost:3708/', '_blank')
    }
  }
}
</script>
