...
export default {
  ...
  data() {
    return {
      config: getServiceConfig('echo')
    }
  },
  methods: {
    refreshData() {
      console.log('Atualizando dados do Echo...')
      // Aqui você faria a chamada para a API do Echo
      // e atualizaria os dados em tempo real
    },
    openModule() {
      window.open('http://localhost:3704/', '_blank')
    }
  }
}
</script>
