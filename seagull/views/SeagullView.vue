        ...
        <div class="service-card">
          ...
          <div class="card-content">
            ...
            <div class="balance-details">
              ...
              <div class="detail-item">
                <span class="detail-label">Sensores:</span>
...
export default {
  ...
  data() {
    return {
      config: getServiceConfig('seagull')
    }
  },
  methods: {
    refreshData() {
      console.log('Atualizando dados do Seagull...')
      // Aqui você faria a chamada para a API do Seagull
      // e atualizaria os dados em tempo real
    },
    openModule() {
      window.open('http://localhost:3710/', '_blank')
    }
  }
}
</script>
