        ...
        <div class="card-content">
          ...
          <div class="balance-details">
            ...
            <div class="detail-item">
              ...
              <span class="detail-value">{{ sourceStatus.recordsProcessed }}</span>
            </div>
            <div class="detail-item">
...
export default {
  ...
  data() {
    return {
      sourceStatus: {
        status: 'ONLINE',
        description: 'Conexão ativa com SEFAZ',
      ...
      configurations: [
        {
          id: 1,
          name: 'API Endpoint',
          value: 'https://sefaz.gov.br/api/v1',
          status: 'online',
          statusText: 'ATIVO'
        },
        {
      ...
      recentLogs: [
        ...
        {
          id: 2,
          title: 'Atualização de CNPJs',
          message: '45 novos CNPJs adicionados',
        ...
        },
        {
          ...
          message: 'Backup dos dados SEFAZ realizado',
        ...
        },
        {
          ...
          message: 'Cache de consultas limpo',
