        ...
        <div class="logo-section">
          ...
          <div class="logo-text-container">
            ...
            <div class="module-title-with-icon">
              <div class="module-icon icon-beacon"></div>
    ...
    <div class="canonika-layout" :class="{ 'sidebar-collapsed': sidebarCollapsed }">
      ...
      <nav class="canonika-sidebar" v-if="user" :class="{ 'sidebar-collapsed': sidebarCollapsed }">
        ...
        <ul class="nav-menu">
          ...
          <li class="nav-item" :class="{ active: currentView === 'sinalizacao' }">
            <div class="nav-link" @click="setView('sinalizacao')">
              <div class="nav-icon">
                <i class="fas fa-broadcast-tower"></i>
              </div>
              <div v-if="!sidebarCollapsed" class="nav-text">
                <span class="nav-title">Sinalização</span>
                <span class="service-subtitle">Transmissão</span>
              </div>
            </div>
          </li>
          ...
          <li class="nav-item" :class="{ active: currentView === 'configuracoes' }">
            <div class="nav-link" @click="setView('configuracoes')">
              <div class="nav-icon">
                <i class="fas fa-cogs"></i>
              </div>
              <div v-if="!sidebarCollapsed" class="nav-text">
                <span class="nav-title">Configurações</span>
                <span class="service-subtitle">Sistema</span>
              </div>
            </div>
          </li>
      ...
      <main class="canonika-main" :class="{ 'sidebar-collapsed': sidebarCollapsed }">
        ...
        <div v-else-if="currentView === 'dashboard'" class="dashboard-container">
          <div class="dashboard-header">
            ...
            <p>Sistema de sinalização e transmissão</p>
          </div>
          ...
          <div class="dashboard-grid">
              ...
              <div class="card-content">
                <div class="service-status-list">
                  <div class="service-status online">
                    ...
                    <span class="service-name">Torre de Transmissão</span>
                    <span class="service-port">Ativo</span>
                  </div>
                  <div class="service-status online">
                    <span class="status-dot"></span>
                    <span class="service-name">Sistema de Sinalização</span>
                    <span class="service-port">Conectado</span>
                  </div>
                  <div class="service-status online">
                    <span class="status-dot"></span>
                    <span class="service-name">Módulo de Configuração</span>
            ...
            <div class="dashboard-card">
              <div class="card-header">
                <h3>Estatísticas de Transmissão</h3>
                <div class="card-icon">
              ...
              <div class="card-content">
                <div class="stats-grid">
                  ...
                  <div class="stat-item">
                    ...
                    <div class="stat-label">Intensidade do Sinal</div>
                  </div>
                  <div class="stat-item">
                  ...
                  <div class="stat-item">
                    <div class="stat-value">2.4GHz</div>
                    <div class="stat-label">Frequência Principal</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="dashboard-card">
              ...
              <div class="card-content">
                <div class="quick-actions">
                  <button @click="setView('sinalizacao')" class="quick-action-btn">
                    <i class="fas fa-broadcast-tower"></i>
                    Controlar Sinalização
                  </button>
                  <button @click="setView('transmissao')" class="quick-action-btn">
                    <i class="fas fa-wifi"></i>
                    Configurar Transmissão
                  </button>
                  <button @click="setView('configuracoes')" class="quick-action-btn">
                    <i class="fas fa-cogs"></i>
                ...
                <div class="activity-list">
                  <div class="activity-item">
                    ...
                    <div class="activity-content">
                      <div class="activity-title">Sinal reforçado na torre 3</div>
                      <div class="activity-time">6 minutos atrás</div>
                    </div>
                  </div>
                  <div class="activity-item">
                    <div class="activity-icon">
                    ...
                    <div class="activity-content">
                      <div class="activity-title">Configuração atualizada</div>
                      <div class="activity-time">14 minutos atrás</div>
                    </div>
                  </div>
                  <div class="activity-item">
                    <div class="activity-icon">
                    ...
                    <div class="activity-content">
                      <div class="activity-title">Transmissão reiniciada</div>
                      <div class="activity-time">22 minutos atrás</div>
                    </div>
                  </div>
                </div>
              </div>
...
export default {
  ...
  methods: {
    ...
    getServiceTitle() {
      const titles = {
        'sinalizacao': 'Sistema de Sinalização',
        'transmissao': 'Configuração de Transmissão',
        'configuracoes': 'Configurações do Sistema',
        'relatorios': 'Relatórios de Sinal'
      };
      return titles[this.currentView] || 'Beacon';
    },
    
    getServiceDescription() {
      const descriptions = {
        'sinalizacao': 'Controle e monitoramento de sinais de transmissão',
        'transmissao': 'Configuração de parâmetros de transmissão',
        'configuracoes': 'Configuração geral do sistema de sinalização',
        'relatorios': 'Relatórios detalhados de qualidade e intensidade do sinal'
      };
      return descriptions[this.currentView] || 'Sistema de sinalização e transmissão';
    },
